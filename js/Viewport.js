...
!function () {
    var opt = function() {
        ...
        var MetaHandler = function(){      //MONOSTATE
            if(MetaHandler.prototype.instance){        return MetaHandler.prototype.instance;      }
            var me = this;      var meta = {},_els;
            /**       * _els       * meta = {name:{content:String,seriation:Array,store:{property:String},...},...}       * @method init       */
            function init(){
            ...
            function getContentStore(name){
                ...
                for(var i=0;i<content.length;i++){
                    if(content[i].length<1){
                        ...
                        var ct = content[i].split('='),pp = ct[0];
                        if(pp){
                            store[pp] = ct[1];
                        }
                    }
            ...
            this.hasMeta = function(name){        return meta[name]?1:0;
            }
